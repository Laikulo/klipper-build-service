...
def make_exe():
    ...
    python_config.run_command = "from menuconfig import _main as main; main()"

    # Run a Python module as __main__ when the interpreter starts.
    # python_config.run_module = "menuconfig"

    # Run a Python file when the interpreter starts.
    # python_config.run_filename = "kconfiglib/menuconfig.py"
    ...
    exe.add_python_resources(exe.read_package_root(
        path="kconfiglib",
        packages=["kconfiglib", "menuconfig", "olddefconfig", "genconfig"],
    ))
